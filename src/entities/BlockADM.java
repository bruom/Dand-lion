...
public class BlockADM {
	...
	public static int blocoAtual[] = new int[3];//Bloco em que o usuário se encontra. Sendo x, y, z as posições
	...
	public static void setaCoordsMatriz(int coords[],int identBlockLocal){
		...
		case 1:
			coords[0]=User.quadrante[0]-1;
			coords[1]=User.quadrante[1]-1;
			coords[2]=User.quadrante[2]-1;
			break;
		case 2:
			coords[0]=User.quadrante[0]-1;
			coords[1]=User.quadrante[1]-1;
			coords[2]=User.quadrante[2];
			break;
		case 3:
			coords[0]=User.quadrante[0]-1;
			coords[1]=User.quadrante[1]-1;
